...
void RL78MCCodeEmitter::encodeInstruction(const MCInst &MI, SmallVectorImpl<char> &CB,
                                          SmallVectorImpl<MCFixup> &Fixups,
                                          const MCSubtargetInfo &STI) const {
  /* TODO: look into this auto generated pseudo lowerings
  RL78_MC::verifyInstructionPredicates(MI,
  ...
  for(unsigned i = 0; i < Size; i++) {
    CB.push_back((Bits >> ((Size - i - 1) * 8)) & 0xFF);
  }
  // switch (Size) {
  // case 1:
  //   support::endian::write<uint8_t>(OS, Bits, endianness::big);
  //   break;
  // case 2:
  //   support::endian::write<uint16_t>(OS, Bits, endianness::big);
  //   break;
  // case 3:
  //   support::endian::write<uint16_t>(OS, Bits >> 8, endianness::big);
  //   support::endian::write<uint8_t>(OS, Bits, endianness::big);
  //   break;
  // case 4:
  //   support::endian::write<uint32_t>(OS, Bits, endianness::big);
  //   break;
  // case 5:
  //   support::endian::write<uint32_t>(OS, Bits >> 8, endianness::big);
  //   support::endian::write<uint8_t>(OS, Bits, endianness::big);
  //   break;
  // case 6:
  //   support::endian::write<uint16_t>(OS, Bits >> 32, endianness::big);
  //   support::endian::write<uint32_t>(OS, Bits, endianness::big);
  //   break;
  // case 7:
  //   support::endian::write<uint16_t>(OS, Bits >> 40, endianness::big);
  //   support::endian::write<uint8_t>(OS, Bits >> 32, endianness::big);
  //   support::endian::write<uint32_t>(OS, Bits, endianness::big);
  //   break;
  // case 8:
  //   support::endian::write<uint32_t>(OS, Bits >> 32, endianness::big);
  //   support::endian::write<uint32_t>(OS, Bits, endianness::big);
  //   break;
  // default:
